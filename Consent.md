...
|--------------------|:----------:|:-----:|:-------|---------:|
|consentFetchType    |ENUM        |LSP    |Y|List of possible values are ONETIME,PERIODIC.For ConsentHandleRequest value of this field should be ONETIME and For ConsentMonitoring This value should be PERIODIC|
